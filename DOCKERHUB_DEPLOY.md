...
```
docker.io/${DOCKER_HUB_USERNAME}/opendeepwiki-backend:latest
docker.io/${DOCKER_HUB_USERNAME}/opendeepwiki-web:latest
```
...
构建完成后：
- Backend: `docker.io/${DOCKER_HUB_USERNAME}/opendeepwiki-backend:latest`
- Frontend: `docker.io/${DOCKER_HUB_USERNAME}/opendeepwiki-web:latest`
